...
# Generated by qmake (2.01a) (Qt 4.3.2) on: Sat Feb 9 23:44:45 2008
...
SOURCES       = src/helpdialog.cpp \
		...
		src/textroom.cpp build/moc_helpdialog.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/textroom1.0.0/ && $(COPY_FILE) --parents src/helpdialog.h src/optionsdialog.h src/textroom.h build/textroom1.0.0/ && $(COPY_FILE) --parents resource/textroom.qrc build/textroom1.0.0/ && $(COPY_FILE) --parents src/helpdialog.cpp src/main.cpp src/optionsdialog.cpp src/textroom.cpp build/textroom1.0.0/ && $(COPY_FILE) --parents ui/optionsdialog.ui ui/textroom.ui build/textroom1.0.0/ && (cd `dirname build/textroom1.0.0` && $(TAR) textroom1.0.0.tar textroom1.0.0 && $(COMPRESS) textroom1.0.0.tar) && $(MOVE) `dirname build/textroom1.0.0`/textroom1.0.0.tar.gz . && $(DEL_FILE) -r build/textroom1.0.0
...
compiler_moc_header_make_all: build/moc_helpdialog.cpp build/moc_optionsdialog.cpp build/moc_textroom.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_helpdialog.cpp build/moc_optionsdialog.cpp build/moc_textroom.cpp
