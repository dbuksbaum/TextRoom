...
# Generated by qmake (2.01a) (Qt 4.4.0) on: Cum May 23 15:02:52 2008
...
$(TARGET): build/ui_optionsdialog.h build/ui_textroom.h build/ui_helpdialog.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/textroom1.0.0/ && $(COPY_FILE) --parents src/helpdialog.h src/optionsdialog.h src/textroom.h src/searchdialog.h build/textroom1.0.0/ && $(COPY_FILE) --parents resource/textroom.qrc build/textroom1.0.0/ && $(COPY_FILE) --parents src/helpdialog.cpp src/main.cpp src/optionsdialog.cpp src/textroom.cpp src/searchdialog.cpp build/textroom1.0.0/ && $(COPY_FILE) --parents ui/optionsdialog.ui ui/textroom.ui ui/helpdialog.ui build/textroom1.0.0/ && (cd `dirname build/textroom1.0.0` && $(TAR) textroom1.0.0.tar textroom1.0.0 && $(COMPRESS) textroom1.0.0.tar) && $(MOVE) `dirname build/textroom1.0.0`/textroom1.0.0.tar.gz . && $(DEL_FILE) -r build/textroom1.0.0
...
compiler_uic_make_all: build/ui_optionsdialog.h build/ui_textroom.h build/ui_helpdialog.h
compiler_uic_clean:
	-$(DEL_FILE) build/ui_optionsdialog.h build/ui_textroom.h build/ui_helpdialog.h
...
install_documentation: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/usr/local/share/textroom/doc/ || $(MKDIR) $(INSTALL_ROOT)/usr/local/share/textroom/doc/ 
	-$(INSTALL_FILE) /home/gordebak/textroom/textroom/docs/HELP.SHORTCUTS $(INSTALL_ROOT)/usr/local/share/textroom/doc/
	-$(INSTALL_FILE) /home/gordebak/textroom/textroom/docs/LICENSE.GPL $(INSTALL_ROOT)/usr/local/share/textroom/doc/
	-$(INSTALL_FILE) /home/gordebak/textroom/textroom/docs/TODO $(INSTALL_ROOT)/usr/local/share/textroom/doc/


uninstall_documentation:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/local/share/textroom/doc/HELP.SHORTCUTS 
	 -$(DEL_FILE) -r $(INSTALL_ROOT)/usr/local/share/textroom/doc/LICENSE.GPL 
	 -$(DEL_FILE) -r $(INSTALL_ROOT)/usr/local/share/textroom/doc/TODO
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/local/share/textroom/doc/ 
